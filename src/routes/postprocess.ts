...
export const ROLE_MAP: { [name: string]: Role[] } = {
    ...
    'recording engineer': [Role.RC],
    'recording engineers': [Role.RC],
    'recorded': [Role.RC],
    'recorded studio': [Role.RC],
    'recorded studios': [Role.RC],
    'recorded engineer': [Role.RC],
    'recorded engineers': [Role.RC],
    'recorded by': [Role.RC],
    'recorded at': [Role.RC],
    'recorded in': [Role.RC],
    'chorus': [Role.CS],
    ...
    'mixing': [Role.MX],
    'mixing studio': [Role.MX],
    'mixing studios': [Role.MX],
    'mixing engineer': [Role.MX],
    'mixing engineers': [Role.MX],
    'mixed': [Role.MX],
    'mixed studio': [Role.MX],
    'mixed studios': [Role.MX],
    'mixed engineer': [Role.MX],
    'mixed engineers': [Role.MX],
    'mixed by': [Role.MX],
    'mixed at': [Role.MX],
    'mixed in': [Role.MX],
    'mastering': [Role.MA],
    'mastering engineer': [Role.MA],
    'mastering engineers': [Role.MA],
    'mastering studio': [Role.MA],
    'mastering studios': [Role.MA],
    'mastered': [Role.MA],
    'mastered engineer': [Role.MA],
    'mastered engineers': [Role.MA],
    'mastered studio': [Role.MA],
    'mastered studios': [Role.MA],
    'mastered at': [Role.MA],
    'design': [Role.DS],
    'designer': [Role.DS],
    'ボーカル': [Role.V],
